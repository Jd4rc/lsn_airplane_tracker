...
def test_from_opensky():
    # Arrange
    state = ["abc123", "  124", 1591, 616161, 9891, 165.151115, 1415.116165, 1415.116165, False, 65.197, 166.151165]
...
def test_from_opensky_with_none_callsign():
    state = ["abc123", None, 1591, 616161, 9891, 165.151115, 1415.116165, 1415.116165, False, 65.197, 166.151165]
...
def test_from_opensky_with_empty_callsign():
    state = ["abc123", "", 1591, 616161, 9891, 165.151115, 1415.116165, 1415.116165, False, 65.197, 166.151165]
...
def test_from_opensky_with_none_optional_fields():
    state = ["abc123", "  151gfg", None, None, None, None, None, None, False, None, None]
